...
# run with sudo bash train_mlm_tpu_pod.sh
...
MODEL_NAME=legal-spanish-roberta-large
...
BASE_DIR=/home/joelniklaus/MultilingualLegalLMPretraining/src/pretraining

sudo python3 -m torch_xla.distributed.xla_dist --tpu=tpu6 --restart-tpuvm-pod-server -- python3 ${BASE_DIR}/xla_spawn.py --num_cores=${TPU_CORES} ${BASE_DIR}/train_mlm.py \
